...
let ToCheker = window.matchMedia(
  "(min-width: 768px) and (max-width: 1024px)"
).matches;
setInterval(function () {
  let changer = window.matchMedia(
    "(min-width: 768px) and (max-width: 1024px)"
  ).matches;
  if (changer !== ToCheker) {
    ToCheker = changer;
...
let $asideMeunDropdown = document.querySelectorAll(
  "#aside-navbar #dropdown-menu-nav #dropdown-menu-item-nav"
);
